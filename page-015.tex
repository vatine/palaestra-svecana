...
account).\sidenote{The next few sentences make no sense in the
original Swedish, so the translation is as close as I can make it...}
...
When you have after these rules and warnings\sidenote{The original
...
To escape from all of this, mark this general rule against changes
