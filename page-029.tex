...
makes the body skilled, or the legs [dispost]\sidenote{Not entirely
...
used\sidenote{This may be ``can be safely used against stronger
persons'', although dictionary lookups indicate ``stackote'' is a cognate of
'stack' (as in hay stack), }
