...
\item{deporterer} (adj) meaning somewhat unclear (literal translation would be ``deported''), but probably ``lowered''
...
\item{porterer} (adj) Meaning somewhat unclear, but as an opposite of ``deporterer'', probably ``raised''.
...
\item{äst} (konj) ``If is it such that...''
\end{description}
